          ...
          <form>
            <div class="form-group row pa">
              <div class="col-12 col-lg-3 padd">
                ...
                <select class="form-control" id="plan">
                  <option>Escudo Gastos Médicos</option>
                  <option>Excesos Voluntarios</option>
            ...
            <div class="form-group row">
              <div class="col-12 padd df">
                <label for="staticEmail" class="col-form-label titulo"><b>Titular</b></label>  
              </div>
            ...
            <div class="form-group row pm">
              <div class="col-12 col-lg-6 padd padding-left">
                ...
                <input type="email" class="form-control" id="txtcorr" value="" />
              </div>
